...
const ItemCard = ({ item }) => {
    const {id, picture, title, category_bg, category, card_bg, text_color } = item;

    return (
        <div>
            <Link to={`/data/${id}`}>
                <div className="card card-compact bg-base-100 rounded-md" style={{ backgroundColor: card_bg }}>
